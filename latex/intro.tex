...
LeNet-5 classifier. Finally, we made a comparison between our results and the results reported in the paper.

In the following subsections, we start by explanationing some of the key concepts, necessary to understand our work.
