...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=2.5cm]{T20_final.png}\hfil
	\includegraphics[width=2.5cm]{q5_n10_final.png}\hfil
	\includegraphics[width=2.5cm]{T100_final_distr.png}
	\caption{Perturbations of the three algorithms: to the left we have decentralized with T=20, in the center variance-reduced q=7 and n=10, and to the right we have distributed with T=100.}
