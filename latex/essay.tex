...
\usepackage{graphicx}
\graphicspath{ {../data/img/decentralized_stoch/} {../data/img/distributed/}{../data/img/variance_reduced/} {../data/perturbations/decentralized_stoch/}{../data/perturbations/variance_reduced/}{../data/perturbations/distributed/}}
\usepackage{bbold}
